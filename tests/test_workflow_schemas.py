...
class WorkflowSchemaTests(unittest.TestCase):
    def require_api(self):
        self.assertIsNotNone(parse_document, "workflow.schemas is not implemented")
...
from workflow.schemas import SchemaError, SchemaKind, parse_document
