...
from workflow.reviews import ReviewLedgerManager
from workflow.schemas import SchemaKind

try:
    from workflow.review_report import build_review_report_snapshot
except (ImportError, ModuleNotFoundError):
    build_review_report_snapshot = None

try:
    from workflow.review_report import render_review_report_markdown
except (ImportError, ModuleNotFoundError):
...
class WorkflowReviewReportTests(unittest.TestCase):
    def setUp(self):
    ...
    def snapshot(self):
        self.assertIsNotNone(
            ...
            "workflow.review_report build_review_report_snapshot is not implemented",
        )
    ...
    def render(self, snapshot=None):
        self.assertIsNotNone(
            ...
            "workflow.review_report render_review_report_markdown is not implemented",
        )
