...
from workflow.schemas import SchemaError, SchemaKind
from workflow.storage import StorageNotFound, StorageVersionConflict

try:
    from workflow.repository import LoadedDocument, RepositoryError, WorkflowStateRepository
...
class WorkflowRepositoryTests(unittest.TestCase):
    ...
    def require_api(self):
        self.assertIsNotNone(WorkflowStateRepository, "workflow.repository is not implemented")
    ...
    def test_read_rejects_unversioned_state(self):
        repo = self.repo()
