...
from workflow.coordination import BookCoordinationManager
from workflow.filesystem import FilesystemStorage
from workflow.repository import WorkflowStateRepository
from workflow.reviews import ReviewClaimError, ReviewEvidenceError, ReviewLedgerManager
from workflow.schemas import SCHEMA_VERSION, SchemaKind

try:
    from workflow.proposals import ProposalConflict, ProposalManager
...
class WorkflowProposalTests(unittest.TestCase):
    def setUp(self):
    ...
    def manager(self):
        self.assertIsNotNone(ProposalManager, "workflow.proposals ProposalManager is not implemented")
