...
from workflow.storage import StorageNotFound

try:
    from workflow.finalize import (
        FINALIZATION_PATH,
        FinalizationBlocked,
...
class WorkflowFinalizeTests(unittest.TestCase):
    def setUp(self):
    ...
    def require_finalize_api(self):
        self.assertIsNotNone(FinalizationManager, "workflow.finalize is not implemented")
