...
class WorkflowReviewTests(unittest.TestCase):
    ...
    def require_api(self):
        self.assertIsNotNone(ReviewLedgerManager, "workflow.reviews ReviewLedgerManager is not implemented")
        self.assertIsNotNone(ReviewEvidenceError, "workflow.reviews ReviewEvidenceError is not implemented")
        self.assertIsNotNone(ReviewClaimError, "workflow.reviews ReviewClaimError is not implemented")
        self.assertIsNotNone(ReviewConflict, "workflow.reviews ReviewConflict is not implemented")
