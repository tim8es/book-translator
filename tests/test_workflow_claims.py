...
from workflow.storage import StorageAlreadyExists, StorageNotFound

try:
    from workflow.claims import (
        ClaimConflict,
        ClaimManager,
        ClaimOwnershipError,
        ClaimRollbackError,
...
class WorkflowClaimSelectorTests(WorkflowClaimTestMixin, unittest.TestCase):
    def require_api(self):
        self.assertIsNotNone(canonical_unit_id, "workflow.claims canonical_unit_id is not implemented")
        self.assertIsNotNone(resolve_selector, "workflow.claims resolve_selector is not implemented")
        self.assertIsNotNone(InvalidClaimSelector, "workflow.claims InvalidClaimSelector is not implemented")
...
class WorkflowClaimLifecycleTests(WorkflowClaimTestMixin, unittest.TestCase):
    def setUp(self):
    ...
    def require_api(self):
        self.assertIsNotNone(ClaimManager, "workflow.claims ClaimManager is not implemented")
        self.assertIsNotNone(ClaimConflict, "workflow.claims ClaimConflict is not implemented")
        self.assertIsNotNone(ClaimOwnershipError, "workflow.claims ClaimOwnershipError is not implemented")
        self.assertIsNotNone(ClaimRollbackError, "workflow.claims ClaimRollbackError is not implemented")
