...
from workflow.claims import ClaimConflict, ClaimManager
from workflow.coordination import BookCoordinationManager, CoordinationConflict
from workflow.github_storage import GitHubStorage
from workflow.repository import WorkflowStateRepository
from workflow.schemas import SchemaKind
from workflow.status import StatusResolver
from workflow.storage import StorageVersionConflict


NOW = datetime(2026, 9, 7, 12, 0, 0, tzinfo=timezone.utc)


class WorkflowGitHubBackendDomainTests(unittest.TestCase):
    def setUp(self):
