...
try:
    from workflow.text_patch import TextPatchError, TextPatchResult, patch_text
...
class WorkflowTextPatchTests(unittest.TestCase):
    def setUp(self):
    ...
    def require_api(self):
        self.assertIsNotNone(TextPatchError, "workflow.text_patch TextPatchError is not implemented")
        self.assertIsNotNone(TextPatchResult, "workflow.text_patch TextPatchResult is not implemented")
        self.assertIsNotNone(patch_text, "workflow.text_patch patch_text is not implemented")
