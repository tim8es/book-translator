...
from workflow.coordination import FINALIZATION_PATH
from workflow.filesystem import FilesystemStorage
from workflow.finalize import build_reviewed_candidate, sha256_bytes
...
class WorkflowFinalizeReliabilityTests(unittest.TestCase):
    def setUp(self):
